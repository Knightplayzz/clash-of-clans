 ...
 */
async function getPlayersBuilderBaseRankingsByLocationId(locationId, limit) {
    ...
    if (!limit) {
        fetchUrl = `https://api.clashofclans.com/v1/locations/${locationIdConvertString}/rankings/players-builder-base`;
    } else {
        fetchUrl = `https://api.clashofclans.com/v1/locations/${locationIdConvertString}/rankings/players-builder-base?limit=${limit}`;
    }
...
module.exports = { getPlayersBuilderBaseRankingsByLocationId };  