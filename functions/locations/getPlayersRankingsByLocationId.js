 ...
 */
async function getPlayersRankingsByLocationId(locationId, limit) {
    ...
    if (!limit) {
        fetchUrl = `https://api.clashofclans.com/v1/locations/${locationIdConvertString}/rankings/players`;
    } else {
        fetchUrl = `https://api.clashofclans.com/v1/locations/${locationIdConvertString}/rankings/players?limit=${limit}`;
    }
...
module.exports = { getPlayersRankingsByLocationId };  